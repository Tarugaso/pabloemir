export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      {/* Fondo degradado con colores River Plate */}
      <div
        className="absolute inset-0 bg-gradient-to-br from-river-red via-slate-900 to-river-red-dark">
        <div
          className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
        <div
          className="absolute inset-0 bg-gradient-to-r from-river-red/20 to-white/10"></div>
      </div>
        ...
        {[...Array(8)].map((_, i) => (
          <div
            ...
            <div
              ...
              style={{
                background: `linear-gradient(45deg, rgba(220, 20, 60, 0.1), rgba(255, 255, 255, 0.1))`,
              }}></div>
          </div>
        ))}
      </div>
